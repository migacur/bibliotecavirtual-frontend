  ...
  return (
    <footer className='footer'>
        ...
        <div className='footer-contact'>
          <a href='https://www.facebook.com/laeti.anselmobelloso' target="_blank"
          rel="noopener noreferrer">
        <svg className='facebook' xmlns="http://www.w3.org/2000/svg"
        width="38px"
        fill='#FFD700'
        viewBox="0 0 512 512">
          ...
          <div className='footer-aviso'>
            ...
            <p><span>*</span> Para una mejor visualización y experiencia en el sitio se recomienda utilizar una versión reciente de su navegador web.</p>
            <p><span>*</span> Los libros utilizados son una recopilación de diversos sitios web.</p>
            </div>
            </div>
